...
Place the real portfolio project images in this folder. Render will serve them as static assets from `/images/<filename>` after the files are committed to `main`.

## Recommended filenames

- `reflex-control-room.png`
- `solstice-events-co.png`
